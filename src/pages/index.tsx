      ...
      <main>
        <section className='flex items-center justify-center gap-8 mb-8'>
          <div>
            ...
            <p className='text-gray-600 text-xl leading-loose mb-8'>
              I&apos;m a father, a husband, and a software engineer. My mission
              is to write software that improves people&apos;s lives. I have
              experience building and designing for the web, as well as writing
              automated tests.
            </p>
        ...
        <section className='mb-28'>
          <h1 className='text-3xl font-light mb-4'>
            I build{' '}
            <Link href='/work'>
              <a className='heading-link'>projects</a>
            </Link>
          </h1>
          <p className='text-gray-600 text-lg mb-8'>
            I have put my skills to practice by building some interesting things
        ...
        <section className='mb-28'>
          <h1 className='text-3xl font-light mb-4'>
            I write{' '}
            <Link href='/blog'>
              <a className='heading-link'>articles</a>
            </Link>
          </h1>
          <p className='text-gray-600 text-lg mb-8'>
            Occasionally I feel compelled to write about things that I am
            learning or that interests me. I have plans to write new articles
            more frequently to showcase some of the things I have been working
            on.
          </p>
