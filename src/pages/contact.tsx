...
export default function Contact() {
  ...
  async function handleSubmit(event: SyntheticEvent) {
    ...
    const entry = {
      ...
      htmlBody: `Sender: ${
        contactRequest.email
      } | Date: ${new Date().toISOString()}<br>Message: ${contactRequest.body}`,
    };
  ...
  return (
    <>
      <Head>
        <title>Contact | Lucas Castro</title>
      </Head>
      <main>
        ...
        {!submitted ? (
          <>
            <p className='mt-8 text-xl leading-relaxed'>
              Interested in working with me? Would like to leave a suggestion
              for new content? Or do you have a more general question? Please,
              just let me know!
            </p>
            <form onSubmit={handleSubmit} className='w-full mt-8'>
              ...
              <textarea
                ...
                required
              />
              <button type='submit' className='btn mt-12' disabled={loading}>
          ...
          <section className='mt-32 text-center text-xl'>
            ...
            <p className='mb-4'>
              Your request was submitted successfully. I will reach out back to
              you soon!
            </p>
            <p>
              In the meantime feel free to connect with in any of the channels
              below.
            </p>
          </section>
        )}
